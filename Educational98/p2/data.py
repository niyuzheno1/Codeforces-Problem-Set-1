...
def main():
    print("1")
    genrand = lambda x : 100000
    genrand2 =  lambda x: 1 if x % 2 == 0 else 1000000000
    #GetRandomNumber(1,1000000000)
    arr = GenerateAnArray(1, genrand)
    OutputARandomArray(arr)
    arr2 = GenerateAnArray(arr[0], genrand2)
    OutputARandomArray(arr2)
